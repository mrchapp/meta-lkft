...
DESCRIPTION = "Generic Linux Stable RC 5.13 LTS kernel"

PV = "5.13+git${SRCPV}"
SRCREV_kernel = "9f4ad9e425a1d3b6a34617b8ea226d56a119a717"
SRCREV_FORMAT = "kernel"

SRC_URI = "\
    git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable-rc.git;protocol=https;branch=linux-5.13.y;name=kernel \
...
do_deploy_append() {
    ...
    # | KeyError: u'ipq8074'
    ( cd ${B}/arch/arm64/boot/dts/qcom/ && rm -vf *ipq8074* *qcs404* *sdm845* *sm8150* *sc7180* *ipq6018* *sm8250* *qrb5165* *sm8350* *sc7280* *sa8155p* ) || true
}
