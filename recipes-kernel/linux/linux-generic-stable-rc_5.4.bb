...
DESCRIPTION = "Generic Linux Stable RC 5.4 LTS kernel"

PV = "5.4+git${SRCPV}"
SRCREV_kernel = "219d54332a09e8d8741c1e1982f5eae56099de85"
SRCREV_FORMAT = "kernel"

SRC_URI = "\
    git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable-rc.git;protocol=https;branch=linux-5.4.y;name=kernel \
...
do_deploy_append() {
    ...
    # | KeyError: u'ipq8074'
    ( cd ${B}/arch/arm64/boot/dts/qcom/ && rm -vf *ipq8074* *qcs404* *sdm845* *sm8150* ) || true
}
